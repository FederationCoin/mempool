...
export class SeoService {
  network = '';
  baseTitle = 'FederationCoin explorer';
  baseDescription = 'FederationCoin explorer. Experimental. Not Bitcoin. Not a CBDC.';
  baseDomain = 'mempool.federationcoin.org';
  ...
  getTitle(): string {
    if (this.network === 'testnet')
      {return this.baseTitle + ' - FederationCoin Testnet';}
    if (this.network === 'testnet4')
      {return this.baseTitle + ' - FederationCoin Testnet4';}
    if (this.network === 'signet')
      {return this.baseTitle + ' - FederationCoin Signet';}
    if (this.network === 'liquid')
      {return this.baseTitle + ' - Liquid Network';}
    if (this.network === 'liquidtestnet')
      {return this.baseTitle + ' - Liquid Testnet';}
    return this.baseTitle + ' - ' + (this.network ? this.ucfirst(this.network) : 'FederationCoin') + ' Explorer';
  }
