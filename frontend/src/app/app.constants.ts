...
export const specialBlocks = {
  '0': {
    labelEvent: 'Genesis',
    labelEventCompleted: 'The Genesis of FederationCoin',
    networks: ['mainnet', 'testnet', 'testnet4'],
  },
  '210000': {
    labelEvent: 'FederationCoin\'s 1st Halving',
    labelEventCompleted: 'Block Subsidy has halved to 25 BTC per block',
    networks: ['mainnet', 'testnet', 'testnet4'],
  },
  '420000': {
    labelEvent: 'FederationCoin\'s 2nd Halving',
    labelEventCompleted: 'Block Subsidy has halved to 12.5 BTC per block',
    networks: ['mainnet', 'testnet', 'testnet4'],
  },
  '630000': {
    labelEvent: 'FederationCoin\'s 3rd Halving',
