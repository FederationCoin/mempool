...
__TESTNET_ENABLED__=${TESTNET_ENABLED:=true}
...
__ROOT_NETWORK__=${ROOT_NETWORK:=testnet}
__MEMPOOL_WEBSITE_URL__=${MEMPOOL_WEBSITE_URL:=https://mempool.federationcoin.org}
...
__ACCELERATOR_BUTTON__=${ACCELERATOR_BUTTON:=false}
