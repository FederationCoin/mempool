...
# MEMPOOL
__MEMPOOL_NETWORK__=${MEMPOOL_NETWORK:=testnet}
__MEMPOOL_BACKEND__=${MEMPOOL_BACKEND:=none}
...
__CORE_RPC_PORT__=${CORE_RPC_PORT:=35332}
...
__EXTERNAL_DATA_SERVER_LIQUID_API__=${EXTERNAL_DATA_SERVER_LIQUID_API:=}
__EXTERNAL_DATA_SERVER_LIQUID_ONION__=${EXTERNAL_DATA_SERVER_LIQUID_ONION:=}
